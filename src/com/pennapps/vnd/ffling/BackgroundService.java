...
public class BackgroundService extends Service {
    ...
    public void onCreate() {
        ...
        myLocation = (LocationManager) this.getSystemService(LOCATION_SERVICE);
    ...
    private void showNotification() {
        ...
        //PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, BackgroundServiceActivities.Controller.class), 0);
